  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold">Capsule not found</h2>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The capsule couldn't rehydrate. Try again or head home.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CapsuleHub — Portable AI memory" },
      {
        ...
        content:
          "Compress any AI conversation into a structured Capsule and continue the work in any other AI.",
      },
